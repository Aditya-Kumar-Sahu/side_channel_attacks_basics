"""
Program to perform Correlation Power Attack on given data to guess the right key.
"""
...
for subkey in trange(0, 16, desc="Attacking Subkey"):
    ...
    for kguess in trange(0, 256, desc="Generating Hamming Weights"):
    ...
    print(df.head().style.format(format_stat).apply(color_corr_key, axis=0))  # display the current status
